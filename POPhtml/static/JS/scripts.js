$(document).ready(() => {
    ...
    $('#showregpwd').on('click', function() {
      if ($('#pw_reg').attr('psswd-shown') == 'false') {
        $('#pw_reg').removeAttr('type');
        $('#pw_reg').attr('type', 'text');
  
        $('#pw_reg').removeAttr('psswd-shown');
        $('#pw_reg').attr('psswd-shown', 'true');
  
        $('#showregpwd').html('Dölj lösenord');
  
      } else {
        $('#pw_reg').removeAttr('type');
        $('#pw_reg').attr('type', 'password');
  
        $('#pw_reg').removeAttr('psswd-shown');
        $('#pw_reg').attr('psswd-shown', 'false');
  
        $('#showregpwd').html('Visa lösenord');
